...
export default function page() {
  return (
    <>
      <Banner
        className='text-center pb-25 md:pb-40 lg:pb-50 xl:pb-75'
      ...
      >
        <motion.div
          ...
          <Input inputClass='!rounded-full min-h-14 md:min-h-16 lg:min-h-17 !pl-8' placeholder="Enter your email for future updates..." />
