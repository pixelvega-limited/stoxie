...
export default function smarter() {
  return (
    <div className="common-padding relative z-1">
        ...
        <Container>
            <CommonTitle className="mb-8 md:mb-12 lg:mb-16 text-center" title={`<span class='font-extralight'>Unlock</span> Smarter Investing.`} des={'Start free, then pick the plan that fits your investing style.'}/>
            <Pricing/>
        </Container>
    </div>
  )
