    ...
    return (
        <div className='relative z-1'>
            ...
            <motion.h3
                ...
                <span className='font-light'>Never Miss </span>A Market Move
            </motion.h3>
            {never.map((item, index) => (
                <motion.div
                    ...
                    viewport={{ once: once, amount: 0.2 }}
                    className='md:flex bg-background border-2 border-solid border-white/12 rounded-2xl md:rounded-[20px] relative z-1 overflow-hidden'
                    key={index}>
                    <div className='md:w-1/2 pt-6 md:pt-10 xl:pt-20 pl-5 md:pl-8 lg:pl-16 xl:pl-20 md:pb-20  xl:pb-30'>
                        <h3
                            className='mb-4 max-w-120 capitalize'
                            dangerouslySetInnerHTML={{
                                __html: item.title,
                            }}></h3>
                        <p className='text-lg  text-[#C7C9D1] font-euclid font-normal leading-normal mb-6 md:mb-8'>
                            {item.des}
                        </p>
                        <motion.div
                            initial={{ y: y, opacity: 0 }}
