        ...
        <div className='pt-5 md:pt-7.5 relative z-1'>
            ...
            {never.map((item, index) => (
                <motion.div
                    ...
                    className='p-4 md:flex bg-background border-2 border-solid border-white/12 rounded-2xl md:rounded-[20px] relative z-1'
                    key={index}>
                    <motion.div
                        ...
                        <Image
                            ...
                            height={406}
                            alt=''
                            className='max-w-full object-cover mx-auto rounded-lg md:rounded-2xl'
                        />
                    </motion.div>
                    <div className='md:w-1/2 pt-6 md:pt-10 lg:pt-16 xl:pt-20 pl-5 md:pl-10 lg:pl-16 xl:pl-20'>
                        <h3
                            className='mb-4 max-w-96 capitalize'
                        ...
                        {item.list.map((point, index) => (
                            <motion.ul
                                ...
                                <li className='flex items-center gap-2.5 '>
                                    <Verify />
                                    <p className='text-lg  text-[#C7C9D1] font-euclid font-normal leading-normal'>
                                        {point}
                                    </p>
                                </li>
                            </motion.ul>
                        ...
                        <motion.div
                            ...
                            viewport={{ once: once, amount: 0.2 }}>
                            <SecondaryButton
                                className='mt-4 md:mt-6 xl:mt-7.5 mb-4 md:mb-0'
