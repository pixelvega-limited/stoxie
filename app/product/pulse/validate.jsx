        ...
        <div className='relative z-1'>
            ...
            {peak.map((item, index) => (
                <motion.div
                    ...
                    key={index}
                    className='md:flex md:items-center md:gap-x-8 lg:gap-x-10 xl:gap-x-12'>
                    <div className='md:w-1/2'>
                        ...
                        <p className='text-base md:text-lg text-[#C7C9D1] font-euclid font-normal leading-normal mb-6 md:mb-8 max-w-130'>
                            {item.des}
                        </p>
                        <SecondaryButton
