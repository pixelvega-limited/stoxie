  ...
  return (
    <div className='relative z-1'>
      ...
      <motion.h3
        ...
        className='mb-5 md:mb-10 lg:mb-14 xl:mb-16'><span className='font-light'>Invest in </span> The Trends That Matter</motion.h3>
      {peak.map((item, index) => (
        <motion.div
          initial={{ y: y, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
          ...
          viewport={{ once: once, amount: 0.2, }}
          key={index} className='md:flex md:items-center md:gap-x-8 lg:gap-x-10 xl:gap-x-12 mb-8 md:mb-10 lg:mb-14 xl:mb-16'>
          <motion.div
