    ...
    return (
        <>
            <Banner
                ...
                className='pb-15 3xl:pb-41 text-center'
                is_btn_text='Start Free Trial - 30 Days Free'></Banner>
            <div className='pricing relative z-1'>
                ...
                <Container>
                    <div className='py-6 md:py-10 xl:py-16 px-3 md:px-10 lg:px-20 xl:px-40 border-4 border-solid border-white/16 bg-[linear-gradient(180deg,rgba(255,255,255,0)_0%,rgba(255,255,255,0.06)_100%)] rounded-2xl md:rounded-3xl lg:rounded-[30px] relative z-1 overflow-hidden'>
                        ...
                        <div className='absolute top-0 right-0 h-full -z-1'>
                            <Image
                        ...
                        <motion.h3
                            ...
                            <span className='font-light'>Pick the Plan </span>{' '}
                            That Suits You Best
                        </motion.h3>
                        <Pricing />
                    </div>
