...
import { managements } from '@/app/data/managements';
        ...
        <div>
            <Swiper
                ...
                {managements.map((item, index) => (
                    <SwiperSlide
                        className='mt-auto [&.swiper-slide-active]:mt-0'
                        key={index}>
                        <div className='border w-full border-solid border-white/16 bg-[rgba(255,255,255,0.00)] rounded-2xl md:rounded-3xl lg:rounded-[30px] p-4 flex relative z-1'>
                            ...
                            <div className='absolute bottom-7.5 left-1/2 -translate-x-1/2 text-center z-1'>
                                <h4 className='text-lg md:text-xl text-white font-ft-system font-normal leading-[130%] mb-1'>
                                    {item.name}
                                </h4>
                                <p className='text-sm text-[#C7C9D1] font-euclid font-light leading-[130%]'>
                                    {item.position}
                                </p>
                            </div>
                        </div>
            ...
            <div className='swiper-nav flex items-center justify-center gap-3 pt-8 md:pt-10 lg:pt-12 xl:pt-16'>
                <button
                    className='flex gradient-border items-center justify-center p-8 md:p-10 xl:p-12 rounded-full border border-solid border-white/8 bg-transparent hover:bg-white/20'
                    title='previous'
                    onClick={prevSlide}>
                    <ArrowLeft />
                </button>
                <button
                    className='flex gradient-border items-center justify-center p-8 md:p-10 xl:p-12 rounded-full border border-solid -rotate-180 border-white/8 bg-transparent hover:bg-white/20'
                    title='previous'
                    onClick={nextSlide}>
                    <ArrowLeft />
                </button>
